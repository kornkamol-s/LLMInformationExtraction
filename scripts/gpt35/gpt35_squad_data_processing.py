...
# df.head(10000).to_json('data/squad/squad_train.jsonl', orient='records', lines=True)
...
# val_df.head(2000).to_json('data/squad/squad_validate.jsonl', orient='records', lines=True)
...
# # test_df['answers'].to_json('data/squad/squad_test_answer.jsonl', orient='records', lines=True)
test_df = test_df.apply(lambda row: _transform_record_test(row), axis=1)

test_df.head(2000).to_json('data/squad/test-after.jsonl', orient='records', lines=True)
